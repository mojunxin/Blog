                ...
                <div class="review-version">
                    <div class="form-box">
                        <div class="article-cont" align="center">
                            <div class="title">
                                <p class="cont-info"><span class="data">${goDetailWhisper.createDate.substring(0,10)}</span><span
                                        class="types">${goDetailWhisper.classCode}</span></p>
                            </div>
                            <p>${goDetailWhisper.content}</p>
                            <img src='<c:url value="${goDetailWhisper.pic}"></c:url> ' style="width:700px;height:600px" >
                        </div>
                        <div class="form">
                    ...
                    <div class="volume">全部留言 <span>${whisperMessageDataCount}</span>
                    </div>
                    <div class="list-cont">

                        <c:forEach items="${goDetailWhisper.messages}" var="message">
                            <div class="cont">
                                <div class="img">
