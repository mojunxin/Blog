...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" http-equiv="Access-Control-Allow-Origin" content="*">
    <title>博客后台监控</title>
...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href='<c:url value="/admin/adminDate/user.jsp" ></c:url> '>用户</a></li>
    ...
    <div class="btn-group" role="group" aria-label="..." id="UserToolbar">
        <div class="btn-group" role="group" aria-label="...">
            <button type="button" class="btn btn-default" id="deleteUserButton">删除</button>
            <button type="button" class="btn btn-default"
                    data-toggle="modal" data-target="#SaveUserModal">添加
            </button>
        </div>
    </div>
</div>
...
<script src='<c:url value="/admin/adminDate/js/user.js" ></c:url> '></script>
</body>
</html>