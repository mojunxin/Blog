...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href='<c:url value="/admin/adminDate/message.jsp" ></c:url> '>留言</a></li>
        <li role="presentation"><a href='<c:url value="/admin/adminDate/album.jsp" ></c:url> '>相册</a></li>
    </ul>

    <table id="MessageTable"></table>
    <div class="btn-group" role="group" aria-label="..." id="MessageToolbar">
        <div class="btn-group" role="group" aria-label="...">
            <button type="button" class="btn btn-default" id="deleteMessageButton">删除</button>
            <button type="button" class="btn btn-default"
                    data-toggle="modal" data-target="#SaveMessageModal">添加
            </button>
        </div>
    </div>
</div>
...
<div class="modal fade" id="SaveMessageModal" tabindex="-1" role="dialog" aria-labelledby="SaveMessageModalLabel">
...
<script src='<c:url value="/admin/adminDate/js/message.js" ></c:url> '></script>
</body>
</html>