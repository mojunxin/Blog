...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href='<c:url value="/admin/adminDate/album.jsp" ></c:url> '>相册</a></li>
    </ul>

    <table id="AlbumTable"></table>
    <div class="btn-group" role="group" aria-label="..." id="AlbumToolbar">
        <div class="btn-group" role="group" aria-label="...">
            <button type="button" class="btn btn-default" id="deleteAlbumButton">删除</button>
            <button type="button" class="btn btn-default"
                    data-toggle="modal" data-target="#SaveAlbumModal">添加
            </button>
        </div>
    </div>
</div>
...
<div class="modal fade" id="SaveAlbumModal" tabindex="-1" role="dialog" aria-labelledby="SaveAlbumModalLabel">
...
<script src='<c:url value="/admin/adminDate/js/album.js" ></c:url> '></script>
